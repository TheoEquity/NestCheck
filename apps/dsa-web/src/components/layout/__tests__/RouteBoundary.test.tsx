...
describe('RouteOutletBoundary', () => {
  it('catches rejected lazy route imports inside the shell and resets on navigation', async () => {
    ...
    try {
        ...
        <MemoryRouter initialEntries={['/chat']}>
          <Routes>
            ...
            >
              ...
              <Route path="/assets/manage" element={<div data-testid="asset-management-page">Asset Management</div>} />
            </Route>
          </Routes>
        </MemoryRouter>,
      );
      ...
      fireEvent.click(screen.getByRole('link', { name: '资产管理' }));

      expect(await screen.findByTestId('asset-management-page')).toBeInTheDocument();
